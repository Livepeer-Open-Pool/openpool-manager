...
# DEFAULT LOG LEVELS
# -------------------
# Default global log level: info
ENV LOG_LEVEL=info

# Override for each known plugin
# e.g. "LOG_LEVEL_STORAGE=warn" => only show warnings & errors in SqliteStoragePlugin
ENV LOG_LEVEL_STORAGE=debug
ENV LOG_LEVEL_DATALOADER=debug
ENV LOG_LEVEL_PAYOUTLOOP=debug
ENV LOG_LEVEL_API=info
